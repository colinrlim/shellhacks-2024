...
const tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Call this when you want to register the topic as one of the topics for the network node visualization. Do not forget to create the connections between this topic and the other pre-existing topics, when applicable. This function call will automatically set the listed topic as the current_topic.",
            "parameters": {
                "type": "object",
                "properties": {
                    "name": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Call this when you want to create a directed connection to represent a hierarchical relationship between two topics. If you want to establish the two topics as equals in relationship, be sure to call this function again with the arguments flipped. Ensure that all topics registered in the metadata have at least one connection (either as a child_topic or as a prerequisite_topic), even if it is extremely distinct. If you use establish_topic to register a new topic, be sure to call this function as well at least once.",
            "parameters": {
                "type": "object",
                "properties": {
                    "prerequisite_topic": {
                        "type": "string",
                        "description": "The topic to be considered a prerequisite of the child_topic. The inputted value should match the registered topic name exactly, and the topic should already have been registered through establish_topic."
                    },
                    "child_topic": {
                        "type": "string",
...
function do_calls(function_calls) { // DONE
    ...
    for (let i = 0; i < function_calls.length; i++) {
        ...
        if (function_call.name == "create_multiple_choice_question") {  // Create question DONE
            ...
            metadata.registered_topics.value[function_call.arguments.name] = {
                description: function_call.arguments.description,
                relationships: []
            };
            metadata.current_topic = function_call.arguments.name;
        } else if (function_call.name == "establish_connection") {      // Register node relationship DONE
            ...
            metadata.registered_topics.value[function_call.arguments.prerequisite_topic].relationships.push({
                child_topic: function_call.arguments.child_topic,
                strength: function_call.arguments.strength
            });
