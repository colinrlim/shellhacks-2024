...
const tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Call this when you want to create a directed connection to represent a hierarchical relationship between two topics. If you want to establish the two topics as equals in relationship, be sure to call this function again with the arguments flipped.",
            "parameters": {
                "type": "object",
                "properties": {
                    "prerequisite_topic": {
