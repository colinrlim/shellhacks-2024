...
rl.on("line", (input) => __awaiter(void 0, void 0, void 0, function* () {
    if (input.trim().toLowerCase() === "exit") {
        ...
        if (command == "start") {
            ...
            if (questions.length > 0) {
                ...
                rl.question("\nEnter the question index you want to answer: ", (indexStr) => {
                    ...
                    if (index >= 0 && index < questions.length) {
                        ...
                        rl.question("\nEnter your answer (1-4): ", (answer) => __awaiter(void 0, void 0, void 0, function* () {
                            const selectedChoice = parseInt(answer);
                            if (selectedChoice >= 1 && selectedChoice <= 4) {
                                const response = {
                                    selected_choice: selectedChoice,
                                    selected_choice_content: selectedQuestion[`choice_${selectedChoice}`],
            ...
            if (questions.length > 0) {
                listQuestions();
                rl.question("Enter the question index you want to favorite: ", (indexStr) => __awaiter(void 0, void 0, void 0, function* () {
                    const index = parseInt(indexStr);
                    if (index >= 0 && index < questions.length) {
                        const selectedQuestion = questions[index];
